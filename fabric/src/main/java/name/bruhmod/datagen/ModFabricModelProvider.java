...
public class ModFabricModelProvider extends FabricModelProvider {
    public ModFabricModelProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerator) {
        ...
        DataProvider.LOGGER.warn("TODO: use proper music disc models in the future!");
