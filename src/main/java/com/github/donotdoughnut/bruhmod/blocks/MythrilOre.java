...
public class MythrilOre {
    ...
    public static void register() {
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "mythril_ore"), ORE_MYTHRIL_STONE);
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "deepslate_mythril_ore"), ORE_MYTHRIL_DEEPSLATE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "mythril_ore"), ORE_MYTHRIL_STONE_ITEM);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "deepslate_mythril_ore"), ORE_MYTHRIL_DEEPSLATE_ITEM);
...
//            content.addAfter(Items.DEEPSLATE_DIAMOND_ORE, ORE_MYTHRIL_STONE_ITEM);
//            content.addAfter(ORE_MYTHRIL_STONE_ITEM, ORE_MYTHRIL_DEEPSLATE_ITEM);
//        });
    }
