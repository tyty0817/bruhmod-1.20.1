...
public class WizardTowerMapItem extends Item{

    public WizardTowerMapItem() {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!world.isClient()) {
            ...
            var entry = serverWorld.getRegistryManager().get(RegistryKeys.STRUCTURE).getEntry(RegistryKey.of(RegistryKeys.STRUCTURE, new Identifier(MOD_ID, "wizard_tower")));

            if (entry.isEmpty()) {
                LOGGER.warn("Failed to get wizard tower structure!");
            ...
            if (blockPos != null) {
                ...
                itemStack.setCustomName(Text.translatable("item."+MOD_ID+".wizard_tower_map"));
