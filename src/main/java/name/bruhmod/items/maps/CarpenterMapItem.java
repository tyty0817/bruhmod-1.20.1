...
public class CarpenterMapItem extends Item {

    public CarpenterMapItem() {
        super(new Settings());
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!world.isClient()) {
            ...
            var entry = serverWorld.getRegistryManager().get(RegistryKeys.STRUCTURE).getEntry(RegistryKey.of(RegistryKeys.STRUCTURE, new Identifier(MOD_ID, "carpenter")));

            if (entry.isEmpty()) {
                LOGGER.warn("Failed to get carpenter structure!");
            ...
            if (blockPos != null) {
                ...
                itemStack.setCustomName(Text.translatable("item."+MOD_ID+".carpenter_map"));
