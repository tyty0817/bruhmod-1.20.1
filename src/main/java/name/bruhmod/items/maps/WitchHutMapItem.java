...
public class WitchHutMapItem extends Item{

    public WitchHutMapItem() {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!world.isClient()) {
            ...
            var entry = serverWorld.getRegistryManager().get(RegistryKeys.STRUCTURE).getEntry(RegistryKey.of(RegistryKeys.STRUCTURE, new Identifier(MOD_ID, "witch_hut")));

            if (entry.isEmpty()) {
                LOGGER.warn("Failed to get witch hut structure!");
            ...
            if (blockPos != null) {
                ...
                itemStack.setCustomName(Text.translatable("item."+MOD_ID+".witch_hut_map"));
