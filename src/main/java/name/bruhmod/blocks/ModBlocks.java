...
public class ModBlocks {
	...
	*/
	...
	private static final RegistryKey<PlacedFeature> ORE_MYTHRIL_PLACED_KEY = RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(Mod.MOD_ID,"ore_mythril"));
